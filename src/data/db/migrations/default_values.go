...
import "CarSaleAd-Web-Api/data/models"
...
func getDriverSupportSystemsProperties(cat int) *[]models.Property {
	var props []models.Property = []models.Property{
		{
			Name:        "Parking radar",
			CategoryId:  cat,
...
func getSeatsAndSteeringWheelProperties(cat int) *[]models.Property {
	var props []models.Property = []models.Property{
		{
...
func getWindowsAndMirrorsProperties(cat int) *[]models.Property {
	var props []models.Property = []models.Property{
		{
			Name:        "Power windows",
			CategoryId:  cat,
